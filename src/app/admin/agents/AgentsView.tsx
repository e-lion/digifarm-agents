                    ...
                    {(agentsWithMetrics?.length || 0) > 0 ? (
                        <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
                            {agentsWithMetrics?.map((agent, index) => (
                                <div key={agent?.id || `agent-${index}`} className="group flex flex-col p-4 rounded-xl border border-gray-100 bg-white shadow-sm hover:shadow-md transition-all duration-200">
                                        ...
                                        <Dialog>
                                            ...
                                            <DialogContent className="max-h-[80vh] overflow-y-auto">
                                                ...
                                                <div className="mt-4 space-y-3">
                                                    {agent?.visits && (agent.visits?.length || 0) > 0 ? (
